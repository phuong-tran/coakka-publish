...
| --- | --- | --- |
| `coakka-client` native CLI | `1.3.2+caff6d6d` | `coakka-tools/coakka-client/releases/` |
| `coakka-client` Docker Linux bundle | `1.3.2+caff6d6d` | `coakka-tools/coakka-client/docker-demo/releases/` |
| `coakka-runtime-inspect` native UI | `1.3.2+caff6d6d` | `coakka-tools/coakka-runtime-inspect/releases/` |
...
| NuGet | C# runtime package | current; runtime `CoAkka.Runtime==1.3.3` |
