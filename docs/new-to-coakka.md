...
npm install coakka-v2-connector-bun@1.3.1
npm install coakka-v2-connector-electron@1.3.1
npm install coakka-logger-node@1.2.1
npm install coakka-logger-bun@1.2.1
npm install coakka-logger-electron@1.2.1
```
