...
The `coakka-client` Docker Linux bundles and Docker Hub sample images were not
recut in this step; they remain sample/demo convenience surfaces from their
previous generation until the Docker lane is refreshed separately.
