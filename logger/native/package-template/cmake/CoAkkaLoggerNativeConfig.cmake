...
elseif(CMAKE_SYSTEM_NAME STREQUAL "Windows")
  if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64|arm64|ARM64)$")
    set(_coakka_logger_native_platform "windows-aarch64")
  elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^(x86_64|amd64|AMD64)$")
    set(_coakka_logger_native_platform "windows-x86_64")
  else()
    message(FATAL_ERROR "CoAkka logger native package does not include Windows platform: ${CMAKE_SYSTEM_PROCESSOR}")
  endif()
  set(_coakka_logger_native_lib_name "libcoakka_logger_core.dll")
else()
