...
| --- | --- | --- |
| Runtime | `CoAkka.Runtime`, exact `2.5.2` | `2.5.0+4b65d0b2256037bf7fc180bfa6df8c41efc1dd6a` |
...
`3ae74f43d061904d3bdc38a1d84d0479cd6c43bf`; Logger comes from
`801a0a6e67152465568c72246b112beb299360a3`. Runtime `2.5.2` embeds native
...
the [Runtime 2.5.2 NuGet release receipt](../../docs/releases/2026-08-20-nuget-csharp-runtime-2.5.2.md),
