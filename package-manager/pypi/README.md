...
| --- | --- | --- |
| Runtime | `python -m pip install coakka-v2-connector==2.5.1` | `2.5.0+4b65d0b2256037bf7fc180bfa6df8c41efc1dd6a` |
...
PyPI and the artifact mirror contain `coakka_v2_connector-2.5.1-py3-none-any.whl`
from connector source `11c1555` over native generation
...
`6e2a3ef527f866bd334f535705a23dc4a37186d89eac3c2e3cd047655dd75aab`,
...
Exact PyPI `2.5.1` request/reply executes from a clean registry install on
...
counters. The registry `2.5.1` wheel exposes File Lane and Stream Lane.
...
[`coakka-v2-connector` artifact README](../../runtime/python/releases/2.5.0+4b65d0b2256037bf7fc180bfa6df8c41efc1dd6a-11c1555/README.md)
