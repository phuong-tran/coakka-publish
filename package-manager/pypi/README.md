...
| --- | --- | --- |
| Runtime | `python -m pip install coakka-v2-connector==2.5.2` | `2.5.0+4b65d0b2256037bf7fc180bfa6df8c41efc1dd6a` |
...
PyPI and the artifact mirror contain `coakka_v2_connector-2.5.2-py3-none-any.whl`
from connector source `3ae74f4` over native generation
...
`d28123f38e60ee76fec8fb545e37b75ec94bf56ba7d2cbccd028f907aa1ae819`,
...
Runtime `2.5.2` adds typed File receive and Stream publish owner grants,
validated trusted reconstruction, and exact replica-owner endpoint pinning.

Exact PyPI `2.5.2` request/reply executes from a clean registry install on
...
counters. The registry `2.5.2` wheel exposes File Lane and Stream Lane.
...
[`coakka-v2-connector` artifact README](../../runtime/python/releases/2.5.0+4b65d0b2256037bf7fc180bfa6df8c41efc1dd6a-3ae74f4/README.md)
