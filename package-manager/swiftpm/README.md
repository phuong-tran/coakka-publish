...
| --- | --- | --- |
| Runtime | `https://github.com/phuong-tran/coakka-runtime-swift.git`, exact `2.4.1` | `2.4.0+c2f53117` |
...
Bundled runtime generation `2.4.0+c2f53117` contains verified native payloads
