# Dropbox Artifact Publisher Runtime Addon
...
Fetches one exact Dropbox rev through OAuth and distributes the verified bytes through File Lane.

## Native Coordinate

```text
runtime-addons/artifact-publisher-dropbox/native/releases/1.1.0+d1032f6d/
  coakka-runtime-addon-artifact-publisher-dropbox-native-1.1.0.tar.gz
```
