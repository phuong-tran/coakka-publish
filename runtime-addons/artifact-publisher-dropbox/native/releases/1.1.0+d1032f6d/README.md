# Dropbox Artifact Publisher Native 1.1.0

Release generation: `1.1.0+d1032f6d`

Published archive: `coakka-runtime-addon-artifact-publisher-dropbox-native-1.1.0.tar.gz`
...
python3 scripts/verify-runtime-addon-release.py \
  --release-dir runtime-addons/artifact-publisher-dropbox/native/releases/1.1.0+d1032f6d \
  --expected-addon artifact-publisher-dropbox
```
