# Google Cloud Storage Artifact Publisher Runtime Addon
...
```text
runtime-addons/artifact-publisher-gcs/native/releases/1.1.0+d1032f6d/
  coakka-runtime-addon-artifact-publisher-gcs-native-1.1.0.tar.gz
```
