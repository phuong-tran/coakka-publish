# Google Drive Artifact Publisher Runtime Addon
...
Fetches one retained Drive blob revision through OAuth and distributes the verified bytes through File Lane.

## Native Coordinate

```text
runtime-addons/artifact-publisher-google-drive/native/releases/1.1.0+d1032f6d/
  coakka-runtime-addon-artifact-publisher-google-drive-native-1.1.0.tar.gz
```
