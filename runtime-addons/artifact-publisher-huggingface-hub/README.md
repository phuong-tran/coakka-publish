# Hugging Face Hub Artifact Publisher Runtime Addon
...
Fetches one full-commit-pinned Hub file with bounded redirect and credential isolation, then distributes it through File Lane.

## Native Coordinate

```text
runtime-addons/artifact-publisher-huggingface-hub/native/releases/1.1.0+d1032f6d/
  coakka-runtime-addon-artifact-publisher-huggingface-hub-native-1.1.0.tar.gz
```
