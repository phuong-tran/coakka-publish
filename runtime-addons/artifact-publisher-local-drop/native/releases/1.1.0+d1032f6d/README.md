# Local Drop Artifact Publisher Native 1.1.0

Release generation: `1.1.0+d1032f6d`

Published archive: `coakka-runtime-addon-artifact-publisher-local-drop-native-1.1.0.tar.gz`

Supported platforms: `linux-aarch64`, `linux-x86_64`, `macos-aarch64`. Minimum Runtime native version: `2.4.0`.
...
python3 scripts/verify-runtime-addon-release.py \
  --release-dir runtime-addons/artifact-publisher-local-drop/native/releases/1.1.0+d1032f6d \
  --expected-addon artifact-publisher-local-drop
```
