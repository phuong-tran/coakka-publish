# OCI Distribution Artifact Publisher Runtime Addon
...
Fetches one digest-addressed OCI Distribution blob and distributes the verified bytes through File Lane.

## Native Coordinate

```text
runtime-addons/artifact-publisher-oci-registry/native/releases/1.1.0+d1032f6d/
  coakka-runtime-addon-artifact-publisher-oci-registry-native-1.1.0.tar.gz
```
