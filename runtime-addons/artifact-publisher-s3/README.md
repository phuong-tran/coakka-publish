# S3 Artifact Publisher Runtime Addon
...
Fetches one version-pinned S3 or MinIO object through SigV4, verifies integrity, and distributes it through File Lane.

## Native Coordinate

```text
runtime-addons/artifact-publisher-s3/native/releases/1.1.0+d1032f6d/
  coakka-runtime-addon-artifact-publisher-s3-native-1.1.0.tar.gz
```
