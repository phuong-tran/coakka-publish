# SFTP Artifact Publisher Native 0.2.0

Release generation: `0.2.0+c5656cc8`
...
python3 scripts/verify-runtime-addon-release.py \
  --release-dir runtime-addons/artifact-publisher-sftp/native/releases/0.2.0+c5656cc8 \
