...
The `2.5.3` package uses Bun-specific lane-owner declarations so its public
type surface does not expose the Node-only Koffi implementation detail.
...
```text
bun/coakka-v2-connector-bun-2.5.3.tgz
```
