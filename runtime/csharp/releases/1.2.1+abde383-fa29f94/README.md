...
- native package version `1.2.1+abde383` is preferred from
...
```text
csharp/build/nupkg/CoAkka.Runtime.1.2.1.nupkg
```
...
3. staged native under `v2/staging/native/1.2.1+abde383/<platform>/`
