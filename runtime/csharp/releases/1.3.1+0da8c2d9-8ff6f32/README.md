...
- native package version `1.3.6+0da8c2d9` is preferred from
...
```text
csharp/build/nupkg/CoAkka.Runtime.1.3.6.nupkg
```
...
3. staged native under `v2/staging/native/1.3.6+0da8c2d9/<platform>/`
