...
- native package version `1.3.2+caff6d6d` is preferred from
...
```text
csharp/build/nupkg/CoAkka.Runtime.1.3.2.nupkg
```
...
3. staged native under `v2/staging/native/1.3.2+caff6d6d/<platform>/`
