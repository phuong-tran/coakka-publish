...
Connector version `1.4.7` uses exact native generation
`1.4.1+9e02a51d`.
...
dotnet add package CoAkka.Runtime --version 1.4.7 --source coakka-local
```
...
The package verifier requires all five exact release-metadata digests. Current
execution evidence covers macOS ARM64; this package receipt makes no C#
connector/consumer execution claim for Linux or Windows. Use
