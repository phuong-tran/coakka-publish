...
`2.5.1+26f7944de4a4e0598845a54e4775f9463a9e33be`. The managed API and public C
ABI remain unchanged; the native patch fixes Stream Lane cancellation and
control-window liveness.

## 2.5.2

Adds validated File and Stream Lane owner-grant types, public control-plane
reconstruction, exact-owner endpoint pinning, and live owner-aware smokes.
File grants are transfer-scoped; Stream grants are single-admission. Native
...
CoAkka Native Artifact License 1.2 package map. Native code, managed API, ABI,
and the exact native generation are unchanged.
