...
Version `2.5.2` contains owner-aware File and Stream Lane connector surfaces for Electron main
over exact native generation `2.5.0+4b65d0b2256037bf7fc180bfa6df8c41efc1dd6a`. Keep runtime ownership in the
