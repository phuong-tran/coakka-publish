...
- `version`: `1.3.6-g0da8c2d9-8ff6f32`
...
```kotlin
dependencies {
    implementation("coakka.v2:coakka-jvm-native-runtime-v2:1.3.6-g0da8c2d9-8ff6f32")
}
```
...
Private probe smoke over the sibling native probe binary:
