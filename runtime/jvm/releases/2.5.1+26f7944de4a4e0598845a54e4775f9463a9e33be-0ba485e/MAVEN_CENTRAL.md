...
The published `2.5.3` Central package embeds the exact Core `2.5.1`
...
Version `2.5.3` is published. The commands below are retained as the exact
reproduction path for its signed bundle.
...
Version `2.5.3` was published on 2026-08-21 through user-managed deployment
`669d4add-e160-4ecf-afbb-a84057ad351b`. The signed bundle SHA-256 is
`0918179a6f39814ab3109f93097ed6e4ed82dc3e8fdf03649028437452def0cb`;
the public main JAR SHA-256 is
`36a3ca8d0f04a5dc41de9647c665dc80c4839dd6be974b010e6df096b11f8068`.
All five public base artifacts and detached signatures match the signed bundle
byte-for-byte. A public-repository Java 8 consumer reports exact Core `2.5.1`,
commit `26f7944de4a4e0598845a54e4775f9463a9e33be`, and completes request/reply.
