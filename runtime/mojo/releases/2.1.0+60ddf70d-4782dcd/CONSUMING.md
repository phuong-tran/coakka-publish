...
```sh
tar -xzf coakka-runtime-mojo-2.1.0-source.tar.gz
cd coakka-runtime-mojo-2.1.0-source
...
is maintained in [common troubleshooting](https://github.com/phuong-tran/coakkaCoreNativeDev/blob/main/v2/docs/common/troubleshooting.md).
