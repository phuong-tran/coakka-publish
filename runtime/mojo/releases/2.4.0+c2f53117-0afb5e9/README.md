...
- [Troubleshooting](https://github.com/phuong-tran/coakka-publish/blob/main/docs/troubleshooting.md), including Linux loader checks, Gatekeeper, Windows publisher warnings, checksums, and signing status
