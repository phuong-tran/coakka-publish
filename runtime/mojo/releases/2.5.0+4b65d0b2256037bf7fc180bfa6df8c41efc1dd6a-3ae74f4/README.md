...
Version `2.5.2-source` contains File and Stream owner-grant conformance smokes
over exact native generation
`2.5.0+4b65d0b2256037bf7fc180bfa6df8c41efc1dd6a`. They prove endpoint pinning
