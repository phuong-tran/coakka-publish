...
Version: `2.5.3-source`<br>
Native generation: `2.5.1+26f7944de4a4e0598845a54e4775f9463a9e33be`<br>
...
Version `2.5.3-source` contains File and Stream owner-grant conformance smokes
over exact native generation
`2.5.1+26f7944de4a4e0598845a54e4775f9463a9e33be`. They prove endpoint pinning
and data movement through the C shim; they are not a stable high-level Mojo
grant API. Follow the public [streaming contract](https://github.com/phuong-tran/coakka-samples/blob/main/docs/runtime-streaming.md)
and [owner-grant contract](https://github.com/phuong-tran/coakka-samples/blob/main/docs/runtime-lane-owner-grants.md).
