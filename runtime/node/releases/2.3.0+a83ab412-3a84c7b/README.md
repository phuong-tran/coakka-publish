...
matching-host execution. Exact npm `coakka-v2-connector-node@2.3.0`
...
path for blocking waits. Package `2.3.0` includes the File-Lane-capable native
runtime `2.3.0+a83ab412`; see the shared [file-lane contract](https://github.com/phuong-tran/coakka-publish/blob/main/docs/runtime-file-transfer.md).
