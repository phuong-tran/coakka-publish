...
matching-host execution. Exact npm `coakka-v2-connector-node@2.4.1`
...
path for blocking waits. Package `2.4.1` includes the File-Lane-capable native
runtime `2.4.0+c2f53117`; see the shared [file-lane contract](https://github.com/phuong-tran/coakka-publish/blob/main/docs/runtime-file-transfer.md).
