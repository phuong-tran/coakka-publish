...
| Linux x86-64 | Yes | Runtime payload format and digest verified; no Python execution claim in this receipt |
| Windows ARM64 | Yes | Runtime payload format and digest verified; no Python execution claim in this receipt |
| Windows x86-64 | Yes | Runtime payload format and digest verified; no Python execution claim in this receipt |
