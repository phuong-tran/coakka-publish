...
python -m pip install python/build/wheelhouse/coakka_v2_connector-2.5.2-py3-none-any.whl
```
...
- release-candidate wheel `2.5.2` request/reply passes on macOS ARM64 and Linux
  ARM64/x86-64
- the same 2.5.2 source passes Windows ARM64 after selecting `PeekNamedPipe`
