...
- Preserves the Python API and public C ABI while adopting the Stream Lane
  cancellation and control-window liveness fix.

## 2.5.2

- Adds typed File and Stream Lane owner grants, JSON/control-plane
  reconstruction, exact-owner endpoint pinning, and live owner-aware tests.
