...
The verified `2.5.3-source` candidate uses exact native generation
`2.5.1+26f7944de4a4e0598845a54e4775f9463a9e33be`. Publication remains a separate
release gate.
...
`2.5.3-source` aggregate package gives the trusted Rust host the owner-aware
