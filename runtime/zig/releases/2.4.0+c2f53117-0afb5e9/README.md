...
Connector version: `2.4.0-source`<br>
Native generation: `2.4.0+c2f53117`<br>
...
- [Troubleshooting](https://github.com/phuong-tran/coakka-publish/blob/main/docs/troubleshooting.md), including Linux loader, Gatekeeper, Windows publisher warnings, checksums, and absent signing
- [Contact/support](https://github.com/phuong-tran/coakka-publish/blob/main/docs/contact-and-support.md)
